...
public class SimulatorNode : Object
{
    ...
    public fk_101.Fk101Service srv101;
    public fk_101.Fk101Client cli101;
}
...
internal class FileTester : Object
{
    ...
    public void test_file(string fname)
    {
        ...
        string first_node_name = "first_node";
        {
            ...
            n.peers_manager = new PeersManager(n.map_paths,
                                     ...
                                     n.back_factory,
                                     n.neighbor_factory);
            n.srv101 = new fk_101.Fk101Service(gsizes, n.peers_manager, levels);
        }
        ...
        foreach (Directive dd in directives)
        {
            ...
            else if (dd.info)
            {
                ...
                print(@"  my_pos: $(mypos)\n");
                HashMap<int,string> recs = n.srv101.get_records();
                if (! recs.is_empty)
                {
                    foreach (int k in recs.keys)
                        print(@"  srv101: record $(k), $(recs[k])\n");
                }
                print("\n");
            }
            else if (dd.req_read)
            {
                ...
                n.cli101 = new fk_101.Fk101Client(gsizes, n.peers_manager);
                string v = n.cli101.db_read(dd.req_read_k);
            ...
            else if (dd.req_modify)
            {
                ...
                n.cli101 = new fk_101.Fk101Client(gsizes, n.peers_manager);
                n.cli101.db_modify(dd.req_modify_k, dd.req_modify_v);
                print(@"done.\n");
            }
    ...
    private void tasklet_complete_hook(Directive dd)
    {
        ...
        n.peers_manager = new PeersManager(n.map_paths,
                                 ...
                                 n.back_factory,
                                 n.neighbor_factory);
        n.srv101 = new fk_101.Fk101Service(gsizes, n.peers_manager, dd.lvl-1);
